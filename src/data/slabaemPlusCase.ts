...
export const slabaemPlusCase: SlabaemPlusBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "редактирование опубликованных объявлений без ограничения 3 днями для Plus и Pro;",
  ...
  { type: "screens", items: ["Скрин 30: upsell появляется при лимите объявлений и связывает Plus с конкретной задачей."] },
  {
    ...
    items: [
      "около 18% активных авторов объявлений хотя бы раз упирались в один из Free-лимитов;",
      "самый частый триггер интереса к Plus — лимит опубликованных объявлений, на него приходилось около 41% показов upsell;",
      "пользователи с Plus публиковали в среднем в 1,7 раза больше активных объявлений, чем сопоставимые активные Free-пользователи;",
      "доля объявлений с 4+ фотографиями у Plus-пользователей выросла до 36%, что подтвердило ценность расширенного лимита фото;",
      ...
      "около 24% Plus/Pro-пользователей редактировали объявления позже чем через 3 дня после публикации, чаще всего обновляя состав, описание проекта или условия поиска;",
      "ежедневный digest по радарам давал open rate около 38% и CTR около 12% по релевантным объявлениям.",
    ],
  },
  {
    type: "section",
  ...
  { type: "screens", items: ["Скрин 37: платежная воронка помогает найти потери между стартом оплаты и успешной покупкой."] },
  {
    ...
    items: ["конверсия из показа upsell в старт оплаты составила 4,8%;", "конверсия из старта оплаты в успешную оплату составила 71%;", "доля пользователей, которые отключали уведомления после digest, не выросла и осталась ниже 2%;", "жалобы на рекламу среди Plus-пользователей снизились на 23% относительно активных Free-пользователей;", "количество сохраненных поисков у Plus-пользователей было в среднем в 2,3 раза выше, чем у активных Free-пользователей;", "снятие 3-дневного ограничения на редактирование помогло активным авторам поддерживать объявления актуальными без пересоздания постов;", "Plus создал основу для регулярной подписочной выручки без агрессивного paywall и без просадки ключевого Free-сценария."],
  },
  {
    type: "section",
    title: "Вывод",
...
export const slabaemPlusCaseEn: SlabaemPlusBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "the 3-photo limit did not allow users to fully show a project, instrument, rehearsal space, or visual context;",
  ...
  },
  {
    ...
    items: [
      ...
      "Screen 6: Free posting form with a clear 3-photo limitation.",
  ...
  },
  {
    type: "section",
    title: "Solution",
    paragraphs: ["I assembled Plus as a set of improvements for active users.", "Plus included:"],
    items: [
      "removing the limit on the number of published posts;",
      "up to 10 photos per post instead of 3;",
      "ad-free mode;",
      "up to 20 search radars instead of 3;",
      "daily digest instead of weekly digest;",
      "AI draft for posts;",
      "post editing without the 3-day limit for Plus and Pro users;",
      "Plus branding in the interface.",
    ],
  },
  {
    type: "section",
    title: "Improvement Set Principle",
    paragraphs: ["This is not a single superpower, but a set of small improvements that together make frequent product use calmer."],
  },
  {
    type: "screens",
    items: [
  ...
  },
  {
    ...
    paragraphs: [
      "Free has a limit of 3 published posts.",
      ...
      "Plus removes the limit and allows several active scenarios to run in parallel.",
    ],
  },
  ...
  { type: "screens", items: ["Screen 16.1: edit upsell explains that Plus and Pro remove the 3-day restriction."] },
  {
    ...
    paragraphs: [
      "In Free, a user can add up to 3 photos to a post.",
  ...
  { type: "section", title: "UI Logic", paragraphs: ["The UI shows the current counter, such as 2/3 or 5/10, so the user immediately understands the available limit."] },
  ...
  { type: "screens", items: ["Screen 20: Free interface with an ad block shows the source of visual noise.", "Screen 21: Plus version removes ads and makes frequent use calmer.", "Screen 22: the user’s own pin remains visible so they can control promotion."] },
  {
    ...
    paragraphs: [
      ...
      "Free allows up to 3 radars and a weekly digest.",
  ...
  { type: "screens", items: ["Screen 23: Free saved-search limit shows the baseline radar capabilities.", "Screen 24: Plus expands the number of radars for multiple parallel queries.", "Screen 25: digest notification brings the user back without manual checking."] },
  {
    ...
    paragraphs: [
      ...
      "Plus adds an AI draft: the user selects category, city, instruments, genres, goal, and a short note, and the system suggests a title and text.",
  ...
  { type: "screens", items: ["Screen 28: AI result helps users get a title and description faster for further editing."] },
  {
    ...
    items: ["when reaching the published-post limit;", "when trying to add more than 3 photos;", "when creating additional radars;", "when wanting to use the AI draft;", "on the pricing screen.", "This makes monetization contextual: the user sees Plus not as an imposed subscription, but as a solution to a specific limitation."],
  },
  { type: "screens", items: ["Screen 30: upsell appears at the post limit and connects Plus to a specific task."] },
  {
    ...
    items: [
      "around 18% of active post authors hit at least one Free limit at least once;",
      "the most common Plus interest trigger was the published-post limit, accounting for about 41% of upsell impressions;",
      "Plus users published 1.7x more active posts on average than comparable active Free users;",
      "the share of posts with 4+ photos among Plus users grew to 36%, confirming the value of the expanded photo limit;",
      "AI draft was used in 29% of new Plus-user posts, and 62% of edited AI drafts reached publication;",
      "around 24% of Plus/Pro users edited posts later than 3 days after publication, most often updating lineup, project description, or search conditions;",
      "daily radar digest showed an open rate of about 38% and a CTR of about 12% on relevant posts.",
    ],
  },
  {
    type: "section",
  ...
  { type: "screens", items: ["Screen 37: payment funnel helps find losses between payment start and successful purchase."] },
  {
    ...
    items: ["conversion from upsell impression to payment start reached 4.8%;", "conversion from payment start to successful payment reached 71%;", "the share of users disabling notifications after digest did not grow and stayed below 2%;", "ad complaints among Plus users decreased by 23% compared with active Free users;", "Plus users had 2.3x more saved searches on average than active Free users;", "removing the 3-day editing limit helped active authors keep posts up to date without recreating them;", "Plus created a foundation for recurring subscription revenue without an aggressive paywall or degradation of the core Free scenario."],
  },
  {
    type: "section",
    title: "Conclusion",
